...
function Editar(props) {
	...
	<g fill="#000000" stroke={`${props.stroke}`}>
		...
		<path d="M6.396,15.25s2.529-.527,3.701-2.079l5.809-7.695c.566-.75,.417-1.817-.333-2.383h0c-.75-.566-1.817-.417-2.383,.333l-5.809,7.695c-1.172,1.552-.985,4.129-.985,4.129Z" fill="none" stroke={`${props.stroke}`} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"/>
