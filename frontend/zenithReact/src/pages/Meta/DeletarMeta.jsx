                ...
                <div className='w-full h-full flex flex-col items-center justify-center'>
                    <div className='w-3/4 sm:w-1/4 h-auto bg-ice dark:bg-cinzaEscuro p-5 rounded-md'>
                        ...
                        <div className='w-full flex justify-between items-center'>
                            <Link to='/metas'>
                                <Button className='w-auto h-12 bg-transparent p-5 text-cinzaTexto dark:text-white font-bold rounded-md flex items-center justify-center hover:bg-white/20'
                                type="submit" text="Cancelar" />
                            </Link>
                           
                            <button  className='w-1/2 h-12 bg-red-500 text-white p-5 font-bold rounded-md
                            flex items-center justify-center' onClick={deletar}>
