    ...
    <div className='z-20 fixed bottom-0 sm:hidden w-screen h-[10%] bg-ice dark:bg-cinza shadow-lg float-left flex items-center justify-center'>
      <div className='flex-1'>
        <ul className='w-full h-full p-2 flex items-center justify-between'>
          <Link to="/home">
            <Li
              cor={location.pathname === "/home" ? "verde" : "cinzaTexto"}
          ...
          <Link to="/anotacoes">
            <Li
              cor={location.pathname === "/anotacoes" ? "verde" : "cinzaTexto"}
          ...
          <Link to="/relatorio">
            <Li
              cor={location.pathname === "/relatorio" ? "verde" : "cinzaTexto"}
          ...
          <Link to="/metas">
            <Li
              cor={location.pathname === "/metas" ? "verde" : "cinzaTexto"}
