...
import Habilitar2FA from '../../components/Autentificacao/Habilitar2FA';
import { Link } from 'react-router-dom';
import Button from '../../components/Button';
import axios from 'axios';

const PrivacidadeConta: React.FC = () => {
  ...
  const visibilidade = DF === 'true' ? 'block' : 'hidden';
      ...
      <div className='border-y-2 border-cinzaTexto/10 p-4'>
        ...
        <div>
          <p className='pb-3 w-full text-xs leading-3 text-cinzaTexto'>
            Proteja a sua conta com mais uma barreira de Segurança.
          </p>
        </div>
        ...
        <div className={visibilidade}>
          <div className='flex items-center justify-between'>
            ...
            <Link to='2FA/pergunta'>
              <Button text="Editar" className="w-auto h-auto bg-transparent font-bold text-branco p-2 pl-1 rounded-md"/>
            </Link>
          </div>
        </div>
      </div>
