...
const ArquivarAnotacao: React.FC = () => {
    ...
    const arquivar = () => {
        if (id) {
            ...
            toast.error('ID da anotação não fornecido.');
        }
    }
                ...
                <div className='w-full h-full flex flex-col items-center justify-center'>
                    <div className='w-3/4 sm:w-1/4 sm:h-1/4 bg-ice dark:bg-cinzaEscuro p-5 rounded-md'>
                        ...
                        <div className='w-full flex justify-between items-center'>
                            ...
                            <button className='w-1/2 h-12 bg-red-500 text-white p-5 font-bold rounded-md flex items-center' onClick={arquivar}>
