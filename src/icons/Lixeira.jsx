...
function Lixeira(props) {
	...
	<g fill={`${props.fill}`} stroke={`${props.stroke}`}>
		...
		<path d="M13.5,6.75l-.4,7.605c-.056,1.062-.934,1.895-1.997,1.895H6.898c-1.064,0-1.941-.833-1.997-1.895l-.4-7.605" fill="none" stroke={`${props.stroke}`} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"/>
	</g>
</svg>
	);
};
